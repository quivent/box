...
**Bring-up — two roles** (full procedure in [`net/wireguard/README.md`](net/wireguard/README.md) + [`net/wireguard/FLEET.md`](net/wireguard/FLEET.md)):
